...
import { getMajorSpeedTemplate, getMajorSpeedPageImage } from './business/major-speed-template'
...
export default {
  ...
  methods: {
    ...
    pageImage(slot, key) {
      return getMajorSpeedPageImage(this.majorId, slot, key)
    ...
    goReadCourse(courseId, level) {
      ...
      uni.navigateTo({
        ...
        url: `/subpkg/discover/major-course?majorId=${encodeURIComponent(this.majorId)}&courseId=${encodeURIComponent(courseId)}&level=${encodeURIComponent(level)}`,
    ...
    startMajorChallenge(page) {
      ...
      uni.navigateTo({
        ...
        url: `/subpkg/discover/major-challenge?majorId=${encodeURIComponent(this.majorId)}&moduleId=${encodeURIComponent(moduleId)}&task=${encodeURIComponent(task)}`,
