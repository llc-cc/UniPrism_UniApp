        ...
        <view class="glyph-circle" aria-hidden="true">
          <view class="glyph-card">
            <view class="glyph-bar glyph-bar--purple" />
              <view class="glyph-bar glyph-bar--green glyph-bar--delay-1" />
              <view class="glyph-bar glyph-bar--orange glyph-bar--delay-2" />
          </view>
        </view>
      </view>
...
.glyph-circle {
  ...
  align-items: center;
  justify-content: center;
  animation: glyph-circle-pulse 2200ms ease-in-out infinite;
}
.glyph-card {
  width: 66rpx;
  height: 78rpx;
...
.glyph-bar {
  ...
  animation: glyph-bar-rise 1400ms ease-in-out infinite;
...
.glyph-bar--delay-1 { animation-delay: 120ms; }
.glyph-bar--delay-2 { animation-delay: 240ms; }

@keyframes glyph-circle-pulse {
  0%, 100% { transform: scale(1); }
  50% { transform: scale(1.035); }
}

@keyframes glyph-bar-rise {
