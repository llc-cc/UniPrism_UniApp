...
export const MAJOR_EXPERIENCES = [
  {
    ...
    en: 'Mathematics',
    accent: '#1769E0',
    icon: asset('/images/explore/discover/icons/generated/majors/major-math.png'),
  ...
  },
  {
    ...
    en: 'Physics',
    accent: '#06b6d4',
    icon: asset('/images/explore/discover/icons/generated/majors/major-physics.png'),
  ...
  },
  {
    ...
    en: 'Computer Science',
    accent: '#5b6cff',
    icon: asset('/images/explore/discover/icons/generated/majors/major-cs.png'),
  ...
  },
  {
    ...
    accent: '#14b8a6',
    icon: asset('/images/explore/discover/icons/generated/majors/major-ai.png'),
